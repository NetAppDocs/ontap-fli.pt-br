...
summary: 'Somente LUNs FC são suportadas pelo FLI. No entanto, existe uma solução alternativa que permite importar LUNs iSCSI. Como você importará os LUNs iSCSI como LUNs FC, diferentemente de outros fluxos de trabalho online de 7-Mode para ONTAP da FLI, a janela de interrupção abrangerá todo esse fluxo de trabalho:' 
---
...
[role="lead"]
Somente LUNs FC são suportadas pelo FLI. No entanto, existe uma solução alternativa que permite importar LUNs iSCSI. Como você importará os LUNs iSCSI como LUNs FC, diferentemente de outros fluxos de trabalho online de 7-Mode para ONTAP da FLI, a janela de interrupção abrangerá todo esse fluxo de trabalho:
