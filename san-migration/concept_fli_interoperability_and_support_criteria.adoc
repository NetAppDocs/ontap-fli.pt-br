...
summary: 'A Matriz de Interoperabilidade FLI (IMT) é uma ferramenta de interoperabilidade distinta, projetada para oferecer melhor suporte aos arrays de origem qualificados pela NetApp que funcionam com FLI.' 
---
...
[role="lead"]
A Matriz de Interoperabilidade FLI (IMT) é uma ferramenta de interoperabilidade distinta, projetada para oferecer melhor suporte aos arrays de origem qualificados pela NetApp que funcionam com FLI.
