...
Embora o ONTAP não exija mais uma migração conduzida por serviços profissionais, a NetApp recomenda fortemente o envolvimento de serviços profissionais no escopo, planejamento e treinamento para todas as migrações, exceto as mais simples.
...
* Migração de dados entre arrays de armazenamento heterogêneos da EMC, Hitachi, HP e outros fornecedores para a NetApp.
